...
_commander2['default'].option('--save', 'Save the result(s) to the database');
...
command(_commander2['default'], 'daemon', 'Launch a daemon to run scenarios according to a schedule and run web-server to see results');
